...
resourcename="eurovisiondatabase"  # lower case, only
resourcegroup="eurovisiondatabase_rg"
...
# git clone https://github.com/apilogicserver/eurovisiondatabase.git
# cd eurovisiondatabase
...
az group create --name eurovisiondatabase_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group eurovisiondatabase_rg --sku S1 --is-linux
az container create --resource-group eurovisiondatabase_rg --name eurovisiondatabase --image apilogicserver/eurovisiondatabase:latest --dns-name-label eurovisiondatabase --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//eurovisiondatabase.westus.azurecontainer.io:5656'
